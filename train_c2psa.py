#!/usr/bin/env python3
"""
Train C2PSA with BitLinear_TTQ Quantization
FIXED: No DataLoader workers to prevent memory issues
"""
...
# CRITICAL: Disable multiprocessing in DataLoader
...
def main():
    ...
    # CRITICAL: Override workers to 0 to prevent memory issues
    config['train']['workers'] = 0
    print(f"⚠️  Forcing workers=0 to prevent memory issues")
    ...
    # Replace C2PSA with BitLinear_TTQ in SHADOW model only
    ...
    # Move replaced layers to device
